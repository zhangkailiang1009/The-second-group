    ...
    <div id="app">
      <div class="top">
        <router-link to="/info" tag="div" class="topa">
          ...
          <div class="top_right" style="font-size: 3vw">去约课</div>
        </router-link>
        <div class="topb">
          <div class="diva">
            <p>0</p>
    ...
    <ul class="menu-box">
      <li>
        ...
        <div class="item-box">
          ...
          <div class="item">
            <van-icon name="star" @click="add_wdsc" size="25" />
            <p>我的收藏</p>
          </div>
        </div>
      </li>
      ...
      <li>
        ...
        <div class="item-box">
          ...
          <div class="item" @click="zkl_ykjl">
            <van-icon name="bell" size="25" />
            <p>约课记录</p>
          </div>
          <div @click="gr" class="item">
            <van-icon name="manager" size="25" />
            <p>个人</p>
          </div>
        </div>
